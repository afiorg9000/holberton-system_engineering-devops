...
-   You must use [get](https://alx-intranet.hbtn.io/rltoken/CNqOWPW6mdYuK7Ak-f2KHQ "get") to access to dictionary value by key (it won't throw an exception if thekey doesn't exist in the dictionary)
